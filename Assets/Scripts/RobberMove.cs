...
{
    //Ddesde aqui se gestiona la animacion de "echar" al ladron
    ...
    { 
        if(controller.GetComponent<Controller>().state < 4) //se añade condicion para evitar que una vez se haya perdido, una colision de la animacion que regresa las fichas a su puesto incial provoque un mensaje de WIN
        {
